#include "Arduino.h"
#include "Mega2560_SP0256-AL2-SpeechChip.h"

// Mega2560 address bus mapping:
// bit0 -> D22 / PA0 -> SP0256 A1
// bit1 -> D23 / PA1 -> SP0256 A2
// bit2 -> D24 / PA2 -> SP0256 A3
// bit3 -> D25 / PA3 -> SP0256 A4
// bit4 -> D26 / PA4 -> SP0256 A5
// bit5 -> D27 / PA5 -> SP0256 A6
// PA6/PA7 (D28/D29) are preserved.
static inline void speechChipWriteAddress(uint8_t addr)
{
  PORTA = (PORTA & B11000000) | (addr & B00111111);
}
...
void SpeechChip::AddressLoad(int delayTime){
...
void SpeechChip::PA1(){
  speechChipWriteAddress(B00000000);
  AddressLoad(10);
}
